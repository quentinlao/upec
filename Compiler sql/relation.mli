...
sig
  ...
  (* ''crossjoin r1 r2'' retourne le produit cartésien des relations ''r1'' et ''r2'' *)
  ...
  val leftouterjoin: (tuple -> tuple -> bool) -> relation -> relation -> relation
    ...
    (* ''leftouterjoin p r1 r2'' retourne la theta-jointure des relations ''r1'' et ''r2'' en respectant le prédicat ''p'',
     tout en conservant les tuples défaillants de ''r2''
   *)
  val rightouterjoin: (tuple -> tuple -> bool) -> relation -> relation -> relation
